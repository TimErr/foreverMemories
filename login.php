...
<!-- Old Code from before PHP/HTML server session delete after verifying working code.
<!DOCTYPE html>
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Forever Memories Login</title>
                ...
                <div class="mx-auto">
                    ...
                    <form action="loginVerify.php" method="post">
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="form-group col-auto">
                                <label for="passwordRepeat">Re-enter Password again:</label>
                                <input type="password" class="form-control" name="passwordRepeat">
                            </div>
                        </div>

                        <button type="submit" name="button">Log In</a></button>
                    </form>
